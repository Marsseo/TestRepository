...
public class RootController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cb1.setOnAction(e1->handleChkAction());
           
        cb2.setOnAction(e2->handleChkAction());
        ...
        rbGroup.selectedToggleProperty().addListener(new ChangeListener<Toggle>(){
            ...
            */    
            ...
            //how2
                String fileName = newValue.getUserData().toString();
                radioImageView.setImage(new Image(getClass().getResource("images/"+fileName+".png").toString()));
            }    
            });
