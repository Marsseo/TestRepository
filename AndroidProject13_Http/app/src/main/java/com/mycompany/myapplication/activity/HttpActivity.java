...
public class HttpActivity extends AppCompatActivity {
    ...
    public void handleBtnGet(View v) throws IOException {
        ...
        String url = "http://192.168.3.109:8080/myapp/http/exam03";

        HttpUrl httpUrl = HttpUrl.parse(url).newBuilder()
                .addEncodedQueryParameter("param1",txtParam1.getText().toString())
                .addEncodedQueryParameter("param2",txtParam2.getText().toString())
                .build();
    ...
    private boolean checkPermission(){
        ...
        if(     permissionRD != PackageManager.PERMISSION_GRANTED ||
    ...
    public void handleBtnMultipart(View v) {
        ...
        String url = "http://192.168.3.109:8080/myapp/http/exam04";
    ...
    public void handleBtnWebSocketOpen(View v) {
        ...
        String url = "ws://192.168.3.109:8080/SensingCarRemoteWebControl/websocket/thermistorsensor";
