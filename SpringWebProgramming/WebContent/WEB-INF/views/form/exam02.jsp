...
<html>
	...
	<body>
		<h3>회원가입</h3>
		<form method="post" action="exam01" style="padding:0px 20px;" enctype="multipart/form-data">
			...
			<div class="form-group">
				<div class="input-group">
					...
					<input type="date" class="form-control" placeholder="생년월일" name="mbirth" 
						value='<fmt:formatDate value="${ch02Exam03Member.mbirth}" pattern="yyyy-MM-dd"/>'/>
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
