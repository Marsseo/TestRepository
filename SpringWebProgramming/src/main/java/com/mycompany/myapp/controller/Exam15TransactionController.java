...
public class Exam15TransactionController {
	...
	@RequestMapping(value="/transation/exam01", method=RequestMethod.GET)
	public String exam01GET(){
		return "transation/exam01";
	}
	
	@RequestMapping(value="/transation/exam01", method=RequestMethod.POST)
